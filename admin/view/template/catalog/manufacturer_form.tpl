...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <!-- ocshop <h1><img src="view/image/shipping.png" alt="" /> <?php echo $heading_title; ?></h1> -->
	  <h1><img src="view/image/shipping.png" alt="" /> <?php echo $heading_title; ?> &raquo; <?php echo $name; ?></h1>
