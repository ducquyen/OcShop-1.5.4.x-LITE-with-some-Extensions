...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <!-- ocshop <h1><img src="view/image/category.png" alt="" /> <?php echo $heading_title; ?></h1> -->
	  <h1><img src="view/image/category.png" alt="" /> <?php echo $heading_title . ' &raquo; ';
				foreach ($languages as $language)
				echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['name'] : ''; ?></h1>
	  <!-- ocshop -->
