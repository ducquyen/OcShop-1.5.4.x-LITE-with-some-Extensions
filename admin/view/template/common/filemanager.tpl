...
<div id="container">
  ...
  <div id="toolset">
  <button id="btnExpand" class="btn" style="display:none;">Expand Tree</button>
  <button id="btnCollapse"  class="btn" style="display:none;">Collapse Tree</button>
