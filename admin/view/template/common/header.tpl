...
<div id="header">
  ...
  <div id="menu">
    <ul class="left" style="display: none;">
      <li id="dashboard"><a href="<?php echo $home; ?>" class="top"><img src="view/image/minilogo.png" title="<?php echo $heading_title; ?>"></a></li>
...
<div id="quick_links">
  <ul>
  <li><a href="<?php echo $product; ?>"><img src="view/image/product.png" title="<?php echo $text_product; ?>"></a></li>
  <li><a href="<?php echo $category; ?>"><img src="view/image/category.png" title="<?php echo $text_category; ?>"></a></li>
  <li><a href="<?php echo $manufacturer; ?>"><img src="view/image/shipping.png" title="<?php echo $text_manufacturer; ?>"></a></li>
  <li><a href="<?php echo $order; ?>"><img src="view/image/order.png" title="<?php echo $text_order; ?>"></a></li>
  <li><a href="<?php echo $customer; ?>"><img src="view/image/customer.png" title="<?php echo $text_customer; ?>"></a></li>
  </ul>
  </div>
 <?php } ?>
