        ...
        <div id="tab-image">
          <table class="form">
			...
			<tr>
              ...
              <td><div class="image"><img src="<?php echo $contact; ?>" alt="" id="thumb-contact" />
                  <input type="hidden" name="config_contact" value="<?php echo $config_contact; ?>" id="contact" />
                  <br />
                  <a onclick="image_upload('contact', 'thumb-contact');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb-contact').attr('src', '<?php echo $no_image; ?>'); $('#contact').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
            </tr>
			<!-- ocshop -->
            <tr>
