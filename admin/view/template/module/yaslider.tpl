      ...
      <form action="<?php echo $action; ?>" method="post" id="form" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div id="tab-module-<?php echo $module_row; ?>" class="vtabs-content">
          ...
          <div id="tab-language-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>">
            <fieldset>
              <legend><?php echo $text_language_settings; ?></legend>
              <div class="control-group">
                <label class="control-label"><?php echo $text_buy_button_text; ?></label>
                <div class="controls">
              ...
              <div class="control-group">
                <label class="control-label"><?php echo $text_details_button_text; ?></label>
                <div class="controls">
              ...
              <div class="control-group">
                <label class="control-label"><?php echo $text_heading; ?></label>
                <div class="controls">
                  ...
                  <span class="help-inline"><?php echo $help_title_yaslider; ?></span>
                </div>
              </div>
            </fieldset>
          </div>
          <?php } ?>
          <fieldset>
            <legend><?php echo $text_products_settings; ?></legend>
            <div class="control-group">
              <label class="control-label"><?php echo $text_search_products; ?></label>
              <div class="controls">
                <input class="span2" type="text" name="product-search[<?php echo $module_row; ?>]" value="" />
                <span class="help-inline"><?php echo $help_search_products; ?></span>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label"><?php echo $text_selected_products; ?></label>
              <div class="controls">
                <div class="scrollbox">
                  <?php $class = 'odd'; ?>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <span class="help-inline"><?php echo $help_description; ?></span>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label"><?php echo $text_image_width_height; ?></label>
              <div class="controls">
                ...
                <span class="help-inline"><?php echo $help_image_width_height; ?></span>
              </div>
            </div>
          </fieldset>
          <fieldset>
            <legend><?php echo $text_slider_settings; ?></legend>
            <div class="control-group">
              <label class="control-label"><?php echo $text_slideshow_timeout; ?></label>
              <div class="controls">
                ...
                <span class="help-inline"><?php echo $help_slideshow_timeout; ?></span>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label"><?php echo $text_slideshow_effect; ?></label>
              <div class="controls">
            ...
            <div class="control-group">
              <label class="control-label"><?php echo $text_randomize_slides; ?></label>
              <div class="controls">
            ...
            <div class="control-group">
              <label class="control-label"><?php echo $text_slider_width_height; ?></label>
              <div class="controls">
                ...
                <span class="help-inline"><?php echo $help_slider_width_height; ?></span>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label"><?php echo $text_slider_style; ?></label>
              <div class="controls">
            ...
            <div class="control-group">
              <label class="control-label"><?php echo $text_slider_color; ?></label>
              <div class="controls">
            ...
            <div class="control-group">
              <label class="control-label"><?php echo $text_slider_badge; ?></label>
              <div class="controls">
          ...
          <fieldset>
            <legend><?php echo $text_position_settings; ?></legend>
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <span class="help-inline"><?php echo $help_slider_placed; ?></span>
              </div>
            </div>
            <div class="control-group">
