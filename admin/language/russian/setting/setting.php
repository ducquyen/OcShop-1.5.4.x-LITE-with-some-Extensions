...
$_['entry_product_count']        = 'Количество товаров в подкатегории: <br/><span class="help"> Показать количество продуктов в подкатегории в категории меню заголовка магазина. <b> Будьте осторожны, это может вызвать излишнюю нагрузку в производительности для магазинов с большим количеством подкатегорий </b></span>';
...
$_['entry_voucher_min']        = 'Минимальное количество подарочных ваучеров <br/><span class="help"> Минимальное количество ваучеров которые клиент может использовать </span>';
$_['entry_voucher_max']        = 'Максимальное количество подарочных ваучеров <br/><span class="help"> Максимальное количество ваучеров которые клиент может использовать.</span>';
$_['entry_tax']                = 'Отображать цены с налогом:';
$_['entry_vat']                  = 'Валидация номера через VAT <br/><span class="help"> валидировать номер телефона через VAT с помощью сервиса http://ec.europa.eu.</span>';
...
$_['entry_order_edit']           = 'Изменение заказа <br/><span class="help">Количество дней, в течение которых будет разрешено редактирование заказа. Это поле обязательно, поскольку цены и скидки могут изменяться через некоторое время.</span>';
...
$_['entry_image_category']     = 'Размер изображения в описании категории и производителя:';
